...
public class Search {
  ...
  private static List<SearchResult> searchResultList = new ArrayList<SearchResult>();
   ...
   */
  public static List<SearchResult> principal(String arg) {
    // Read the developer key from youtube.properties
    Properties properties = new Properties();
    try {
      InputStream in = Search.class.getResourceAsStream("/" + PROPERTIES_FILENAME);
      //System.out.println("esto es in: " + in);
      properties.load(in);
    ...
    try {
      ...
      String queryTerm = getInputQuery(arg);
   ...
   */
  private static String getInputQuery(String arg) throws IOException {
