...
@ManagedBean(name="listaCatastrofesCSSBean")
@RequestScoped
public class listaCatastrofesCSSBean implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	public void onRowSelect(SelectEvent event) {
		...
		FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("idEventoCatastrofeCSS", idEvento); 		
