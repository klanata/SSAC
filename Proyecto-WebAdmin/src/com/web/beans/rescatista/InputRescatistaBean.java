...
@ManagedBean(name = "inputRescatistaBean")
@ViewScoped
public class InputRescatistaBean implements Serializable {
private static final long serialVersionUID = 9040359120893077422L;
	...
	public String uploadFile(Part part) throws IOException {
		...
		outputFilePath = new File(jboss + "\\Proyecto\\imagenesRescatistas.war\\" + x + fileName);
