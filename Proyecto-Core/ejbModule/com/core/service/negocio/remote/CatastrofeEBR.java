...
public interface CatastrofeEBR {
	...
	public Long ingesarCatastrofe(String nombreEvento, String descripcion, String logo, BigDecimal coordenadasX,BigDecimal coordenadasY, Boolean activa, Boolean prioridad, Collection<Servicio> servicios, Collection<Ong> ongs,PlanDeRiesgo planDeRiesgo)throws Exception;
